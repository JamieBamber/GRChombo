...
output_path=${analysis_dir}/movies/${name}_movie_v2.mp4
ffmpeg -f image2 -framerate 12 -i BBH_SF_movie_%06d.png -c:v libx264 -crf 22 -pix_fmt yuv420p ${output_path}
