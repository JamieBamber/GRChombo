...
class SphericalExtraction
{
  ...
  public:
    //! The constructor
    SphericalExtraction(integration_params_t a_params, double a_dt, double a_time,
	  ...
	  m_restart_time(a_restart_time), m_num_points(m_params.num_points_phi * m_params.num_points_theta),
    ...
    SphericalExtraction(integration_params_t a_params, double a_dt, double a_time,
        ...
        : SphericalExtraction(a_params, a_dt, a_time, (a_dt == a_time),
