...
work_dir=/p/home/jusers/bamber1/juwels/GRChombo/Analysis/ReprocessingTools/VolumeIntegral_NBBH
...
do
	...
	val="$run[8]"; first_number="${!val}"
        ...
        new_dir_path=/p/scratch/pra116/bamber1/ReprocessingTools_outputs/VolumeIntegral_NBBH/${name}
        #
