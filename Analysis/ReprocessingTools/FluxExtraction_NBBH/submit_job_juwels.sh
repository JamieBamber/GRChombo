...
run0007=(0.2 10 0.02 0.5 0 0 0 40 0)
run0008=(0.2 10 0.025 0.5 0 0 0 40 60)
run0009=(0.2 10 0.015 0.5 0 0 0 40 60)
run0010=(0.2 10 0.01 0.5 0 0 0 40 40)
run0011=(0.2 10 0.03 0.5 0 0 0 40 40)
#
run0015=(0.48847892320123 12.21358 1 0.03125 0 0 0 5 0)
run0016=(0.48847892320123 12.21358 1 0.03125 1 -1 0 5 0)
run0017=(0.48847892320123 12.21358 1 0.03125 1 1 0 5 0)
run0018=(0.2 10 1 0.03125 0 0 0 5 0)
run0019=(0.2 10 0.1 0.125 0 0 0 5 0)
run0020=(0.2 10 0.5 0.0625 0 0 0 5 0)
run0021=(0.2 10 0.05 0.25 0 0 0 5 0)
run0022=(0.2 10 0.2 0.0625 0 0 0 5 0)
run0023=(0.2 10 0.3 0.0625 0 0 0 5 0)
run0024=(0.2 10 0.15 0.0625 0 0 0 5 0)
run0025=(0.2 10 0.25 0.0625 0 0 0 5 0)
run0026=(0.2 10 2 0.03125 0 0 0 2 0)
run0027=(0.2 10 5 0.015625 0 0 0 2 0)
...
do
	...
	val="$run[8]"; start_number="${!val}"
        ...
        suffix=_r_${extraction_radius}_v2
