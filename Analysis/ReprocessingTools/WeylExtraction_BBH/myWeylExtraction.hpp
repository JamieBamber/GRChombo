...
#ifndef myWEYLEXTRACTION_HPP_
#define myWEYLEXTRACTION_HPP_
...
class WeylExtraction : public SphericalExtraction
{
  ...
  public:
    //! The constructor
    WeylExtraction(SphericalExtraction::params_t &a_params,
		   string a_output_root_dir, string a_data_subdir, string a_suffix, double a_dt,
    ...
    WeylExtraction(SphericalExtraction::params_t a_params,
      ...
      : WeylExtraction(a_params, a_output_root_dir, a_data_subdir, a_suffix, a_dt, a_time, (a_dt == a_time), a_restart_time)
    {
    }
    ...
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
    {
        ...
        {
            const auto &mode = m_modes[imode];
            std::string integrals_filename = m_output_root_dir + m_data_subdir +
	      "Weyl_integral_" + m_suffix + "_" + 
