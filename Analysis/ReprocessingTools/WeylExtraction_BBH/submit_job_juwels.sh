...
work_dir=/p/home/jusers/bamber1/juwels/GRChombo/Analysis/ReprocessingTools/WeylExtraction_BBH
...
run0028=(0.5 0 0.25 0.00000001 1)
...
do
	...
	# extract parameters                                                                                                                                                                      
        ...
        name=${subdir}_weyl${suffix}
        echo ${name} "Weyl extraction"
        new_dir_path=/p/scratch/pra116/bamber1/ReprocessingTools_outputs/WeylExtraction_GR_BBH/${name}
        #
	mkdir -p ${new_dir_path}
        ...
        sed -i "s|JOBNAME|${run}WE|" slurm_submit
