...
SliceAtts.axisType = SliceAtts.ZAxis  # XAxis, YAxis, ZAxis, Arbitrary, ThetaJ_R
...
frame_dir = "BBH_run{:04d}_J_R_movie".format(run_number) 
try:
...
input_pattern = frame_dir + "/BBH_SF_J_R_movie_%06d.png"
output_movie = root_movie_path + "BBH_SF_J_R_" + subdir + "_movie.mpg"
