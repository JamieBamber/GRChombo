...
SetActivePlots()
DeleteActivePlots()
OpenDatabase("/p/project/pra116/bamber1/BinaryBHScalarField/run0022_mu0.5_delay0_G0_ratio1/BinaryBHSFPlot_*.3d.hdf5 database", 0)
...
DefineScalarExpression("norm_rho", "rho/0.125000")
...
SaveWindowAtts.fileName = "/p/scratch/pra116/bamber1/plots/GR_Binary_BH/BBH_GR_run0022_mu0.5_delay0_G0_ratio1_rho_movie/frame_000000.png"
SaveWindowAtts.family = 0
SaveWindowAtts.format = SaveWindowAtts.PNG  # BMP, CURVE, JPEG, OBJ, PNG, POSTSCRIPT, POVRAY, PPM, RGB, STL, TIFF, ULTRA, VTK, PLY, EXR
SaveWindowAtts.width = 512
SaveWindowAtts.height = 422
...
SaveWindowAtts.outputToCurrentDirectory = 1
SaveWindowAtts.outputDirectory = "."
SaveWindowAtts.fileName = "/p/scratch/pra116/bamber1/plots/GR_Binary_BH/BBH_GR_run0022_mu0.5_delay0_G0_ratio1_rho_movie/frame_000001.png"
SaveWindowAtts.family = 0
SaveWindowAtts.format = SaveWindowAtts.PNG  # BMP, CURVE, JPEG, OBJ, PNG, POSTSCRIPT, POVRAY, PPM, RGB, STL, TIFF, ULTRA, VTK, PLY, EXR
SaveWindowAtts.width = 512
SaveWindowAtts.height = 422
...
SaveWindowAtts.outputToCurrentDirectory = 1
SaveWindowAtts.outputDirectory = "."
SaveWindowAtts.fileName = "/p/scratch/pra116/bamber1/plots/GR_Binary_BH/BBH_GR_run0022_mu0.5_delay0_G0_ratio1_rho_movie/frame_000002.png"
SaveWindowAtts.family = 0
SaveWindowAtts.format = SaveWindowAtts.PNG  # BMP, CURVE, JPEG, OBJ, PNG, POSTSCRIPT, POVRAY, PPM, RGB, STL, TIFF, ULTRA, VTK, PLY, EXR
SaveWindowAtts.width = 512
SaveWindowAtts.height = 422
