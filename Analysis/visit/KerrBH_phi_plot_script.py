...
# file settings
data_root_dir = "/hppfs/work/pn34tu/di76bej/GRChombo_data/KerrSF/"
run_number = 1
...
View2DAtts.windowCoords = (0.5*box_size-0.5*width, 0.5*box_size+0.5*width, 
0.5*box_size-0.5*width,0.5*box_size+0.5*width)
...
# save plot as png
root_plot_path = "/dss/dsshome1/04/di76bej/GRChombo/GRChombo/Analysis/plots/KerrBH/"
filename = "KerrSF_phi_" + subdir + "_n%06d" % number
