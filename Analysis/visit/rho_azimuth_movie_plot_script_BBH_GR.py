...
def make_phi_movie(dd):
	...
	DefineScalarExpression("norm_rho_azimuth","rho_azimuth")
	
	# add plot
	AddPlot("Pseudocolor", "norm_rho_azimuth")
	AddOperator("Slice", 1)
	DrawPlots()
	...
	frame_dir = "BBH_GR_{:s}_rho_azimuth_movie".format(dd.name)
	try:
