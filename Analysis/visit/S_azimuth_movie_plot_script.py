...
frame_dir = "BBH_SF_S_azimuth_run{:04d}_movie".format(run_number)
try:
...
PseudocolorAtts.colorTableName = "RdBu" #"RdBu"
...
for ts in range(0, nts):
	...
	swatts.fileName = root_plot_path + frame_dir + "/BBH_SF_S_azimuth_movie_%06d.png" % ts
	SetPlotOptions(PseudocolorAtts)
