...
def plot_graph():
	...
	if cumulative:
		...
		save_path = home_path + "plots/plots_for_first_paper/Fig_21_mass_flux_Kerr_Schild_cumulative_compare_r_plus_to_500_agreement.pdf"
		...
		save_path = home_path + "plots/mass_flux_Kerr_Schild_compare_lm_r_plus_to_500.pdf"
