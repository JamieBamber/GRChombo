...
def plot_graph():
	...
	plt.tight_layout()
	if log_y:
			save_name = "/home/dc-bamb1/GRChombo/Analysis/plots/plots_for_first_paper/Fig_12_IsoKerr_rho_profile_{:s}_Rmax={:d}_tau={:.1f}_compare_lm_log_y.png".format(scale, R_max, tau)
	else:
