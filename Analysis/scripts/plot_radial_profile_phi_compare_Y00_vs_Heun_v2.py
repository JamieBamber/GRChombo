...
def plot_graph():
	...
	plt.tight_layout()
	save_name = "/home/dc-bamb1/GRChombo/Analysis/plots/IsoKerr_mu{:.1f}_l=m=0_phi_{:s}_tau={:.1f}_maxR={:d}_plot_vs_Heun_v2.png".format(2.0, scale, dd0.time*dd0.mu, R_max)
