...
def plot_graph():
	...
	save_path = home_path + "plots/j_flux_in_R{:.0f}_IsoKerr_compare_mu.png".format(R_max)
	ax1.legend(loc='best', ncol=3, fontsize=legend_font_size, handletextpad=1, labelspacing=0.05, borderpad=0.1, borderaxespad=0.4, columnspacing=1)
