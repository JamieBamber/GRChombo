...
def plot_graph():
	...
	if cumulative:
		...
		plt.title("Cumulative mass flux into BH, $M=1$")
		save_path = home_path + "plots/mass_flux_Kerr_Schild_cumulative_into_r_plus_compare_lm.png"
	else:
		ax1.set_ylabel("flux / $E_0$")
		plt.title("Mass flux into BH, $M=1$")
		save_path = home_path + "plots/mass_flux_Kerr_Schild_into_r_plus_compare_lm.png"
