...
def plot_graph():
	...
	for dd in data_dirs:
		dd.load_data()
		mu = float(dd.mu)
		label_="$m=${:d} N={:d} L={:d}".format(dd.m, dd.N, dd.L)
	...
	ax1.set_title("Max energy density, $M=1,\\mu=0.4,\\chi=0.7,l=1$", wrap=True, fontsize=title_font_size)
	save_path = home_path + "plots/max_rho_IsoKerr_compare_L.png"
