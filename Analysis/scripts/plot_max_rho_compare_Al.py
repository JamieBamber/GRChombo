...
add_data_dir(6, 1, 1, "0.99", "0.4")
add_data_dir(16, 1, -1, "0.99", "0.4")
add_data_dir(17, 1, 1, "0.99", "0.4", "0.5")
add_data_dir(18, 1, 1, "0.99", "0.4", "0.25")
...
def plot_graph():
	...
	ax1.set_title("Max energy density, $M=1,\\mu=0.4,\\chi=0.99,l=m=1$", wrap=True, fontsize=title_font_size)
	save_path = home_path + "plots/max_rho_IsoKerr_compare_Al.png"
