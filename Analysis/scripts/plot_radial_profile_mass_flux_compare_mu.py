...
def plot_graph():
	...
	plt.tight_layout()
	if log_y:
			save_name = "/home/dc-bamb1/GRChombo/Analysis/plots/IsoKerr_J_R_profile_{:s}_Rmax={:d}_tau={:.1f}_compare_mu_log_y.png".format(scale, R_max, tau)
	else:
			save_name = "/home/dc-bamb1/GRChombo/Analysis/plots/IsoKerr_J_R_profile_{:s}_Rmax={:d}_tau={:.1f}_compare_mu.png".format(scale, R_max, tau)
