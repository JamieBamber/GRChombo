...
def load_data():
        ...
        data = {}
        for dd in data_dirs:
                file_name = data_root_path + dd.name + "_mass_ang_mom_flux_r_" + str(r_extract) + "_v2.dat"
        ...
        if cumulative:
                ...
                if mass_or_ang_mom:
                        ...
                        if use_low_pass_filter:
                                ...
                                save_path = plots_path + "Newtonian_BBH_mass_flux_vs_t_r{:d}_compare_lm.png".format(r_extract, av_n)
                else:
                        ...
                        if use_low_pass_filter:
                                ...
                                save_path = plots_path + "Newtonian_BBH_ang_mom_flux_vs_t_r{:d}_compare_lm.png".format(r_extract, av_n)
