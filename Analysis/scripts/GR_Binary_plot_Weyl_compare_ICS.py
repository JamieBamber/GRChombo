...
#add_data_dir(28, "0.5", 0, "0.00000001", 1) # 10^{-8}  
#add_data_dir(18, "0.5", 0, "0.000001", 1) # 10^{-6}  
...
def load_data(l,m):
        ...
        data = {}
        for dd in data_dirs:
                file_name = Weyl_dir + dd.name + "_Weyl_{:d}{:d}.dat".format(l,m)
...
def plot_graph(align=False):
        ...
        if align:
                save_path = plots_path + "GR_BBH_Weyl_Re_22_aligned_compare_ICS.png"
        else:
                save_path = plots_path + "GR_BBH_Weyl_Re_22_compare_ICS.png"
