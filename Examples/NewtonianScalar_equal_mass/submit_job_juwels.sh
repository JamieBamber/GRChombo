...
run0115=(0.48847892320123 12.21358 1 0.0625 0 0 0)
...
run0021=(0.2 10 0.05 0.25 0 0 0)
run0022=(0.2 10 0.2 0.0625 0 0 0)
run0023=(0.2 10 0.3 0.0625 0 0 0)
run0024=(0.2 10 0.15 0.0625 0 0 0)
run0025=(0.2 10 0.25 0.0625 0 0 0)
...
do
	...
	echo "omega_BH = ${omega_BH}"
        ...
        new_dir=${run}_M${M}_d${d}_mu${mu}_dt_mult${dt_mult}_l${l}_m${m}_Al${Al}_L${L}_N${N1}_from_origin
