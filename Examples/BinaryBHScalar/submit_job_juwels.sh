...
work_dir=/p/home/jusers/bamber1/juwels/GRChombo/Examples/BinaryBHScalar
cd $work_dir
...
run_Katy_test=(1.0 0 0.0625 0.0000000001 1 0 0 0) # G = 10^{-10}
...
do
	...
	if (( $l == 0 ))
	then
	   new_dir=${run}_mu${mu}_delay${delay}_G${G}_ratio${ratio}_BinaryBHScalar
	else
	   new_dir=${run}_mu${mu}_delay${delay}_G${G}_ratio${ratio}_l${l}_m${m}_Al${Al}_BinaryBHScalar
        fi

	#new_dir=run_Katy_test_mu1_delay0_G0.0000000001_ratio1_BinaryBHScalar
