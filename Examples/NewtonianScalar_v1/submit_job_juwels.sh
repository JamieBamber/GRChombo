...
work_dir=/p/home/jusers/bamber1/juwels/GRChombo/Examples/NewtonianScalar_v1
cd $work_dir
...
do
	...
	new_dir=${run}_M${M1}_d${d}_mu${mu}_dt_mult${dt_mult}_l${l}_m${m}_Al${Al}_L${L}_N${N1}_v1
        echo ${new_dir}
	...
	sed -i "s|BHMASS2|${M1}|" ${new_dir_path}/params.txt
