...
#include "FixedBGDensityAndMom_withDetGamma.hpp"
                                       ...
                                       const double a_time)
{
    ...
    SetValue set_static_rhs_zero(0.0, Interval(c_chi, c_S_r));
...
{
    plot_states = {c_phi, c_Pi, c_chi, c_rho, c_S_azimuth, c_S_r};
}
