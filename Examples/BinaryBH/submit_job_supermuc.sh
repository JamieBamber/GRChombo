...
work_dir=/dss/dsshome1/04/di76bej/GRChombo/GRChombo/Examples/BinaryBH
cd $work_dir
data_directory=/hppfs/work/pn34tu/di76bej/GRChombo_data/BinaryBH
...
new_dir=run${text_number}_BinaryBH
echo ${new_dir}
